# Graph Report - firesight-web-v2  (2026-09-16)

## Corpus Check
- 265 files · ~99,404 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 26 file(s) not represented in the graph (top: (none) 19, .geojson 2, .example 1)

## Summary
- 1443 nodes · 2881 edges · 107 communities (82 shown, 8 thin omitted)
...
### Community 1 - "@inertiajs/react"
Cohesion: 0.12
Nodes (22): @inertiajs/react, AnnouncementFormModal(), AnnouncementRow, TYPE_OPTIONS, DeleteAnnouncementDialog(), CompleteReportModal(), INCIDENT_TYPES, SEVERITY_LEVELS (+14 more)
...
Cohesion: 0.19
Nodes (11): AppContent(), Props, AppShell(), Props, AppSidebarHeader(), Breadcrumbs(), SidebarTrigger(), AppSidebarLayout() (+3 more)

### Community 4 - "map/index.tsx"
Cohesion: 0.12
Nodes (28): react-leaflet, BarangayFeature, BarangayGeoProperties, BarangayRiskMap(), BARANGAY_GEOJSON_URL, GEOJSON_TO_DB_BARANGAY_NAME, resolveDbBarangayName(), RiskLevel (+20 more)
...
Cohesion: 0.10
Nodes (23): @radix-ui/react-avatar, DeletePersonnelDialog(), PersonnelFormModal(), Avatar(), AvatarFallback(), AvatarImage(), DropdownMenu(), DropdownMenuGroup() (+15 more)
...
Cohesion: 0.15
Nodes (17): AppLogo(), AppSidebar(), footerNavItems, mainNavItems, NavFooter(), NavMain(), SidebarContent(), SidebarFooter() (+9 more)

### Community 11 - "utils.ts"
Cohesion: 0.23
Nodes (10): AppHeader(), Checkbox(), IsCurrentOrParentUrlFn, IsCurrentUrlFn, useCurrentUrl(), UseCurrentUrlReturn, WhenCurrentUrlFn, SettingsLayout() (+2 more)
...
Cohesion: 0.18
Nodes (7): Controller, ProfileController, SecurityController, Illuminate\Auth\Middleware\RequirePassword, Illuminate\Contracts\Auth\MustVerifyEmail, Illuminate\Support\Facades\Auth, Illuminate\Support\Facades\Route

### Community 14 - "cn"
Cohesion: 0.09
Nodes (33): @radix-ui/react-dialog, @radix-ui/react-dropdown-menu, DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuItem(), DropdownMenuLabel(), DropdownMenuRadioItem(), DropdownMenuSeparator() (+25 more)

### Community 15 - "Illuminate\Database\Eloquent\Model"
Cohesion: 0.12
Nodes (6): NotificationController, BfpPersonnelDetails, Notification, RiskAssessment, Illuminate\Database\Eloquent\Model, Illuminate\Database\Eloquent\Relations\BelongsTo

### Community 16 - "Illuminate\Http\Request"
Cohesion: 0.10
Nodes (15): AnnouncementController, EnsureBfpAdmin, EnsureBfpStaff, HandleAppearance, HandleInertiaRequests, Announcement, Closure, Illuminate\Foundation\Application (+7 more)

### Community 17 - "use-appearance.tsx"
Cohesion: 0.11
Nodes (24): sonner, Toaster(), TooltipProvider(), Appearance, applyTheme(), getStoredAppearance(), handleSystemThemeChange(), initializeTheme() (+16 more)
...
Cohesion: 0.23
Nodes (8): PaginationBar(), BarangayOption, Filters, IncidentRow, inputStyle, STATUS_FILTERS, Paginated, PaginationLink

### Community 20 - "status-badge.tsx"
Cohesion: 0.15
Nodes (18): AnnouncementBadge(), PersonnelStatusBadge(), RoleBadge(), ANNOUNCEMENT_CFG, AnnouncementType, BadgeCfg, PERSONNEL_STATUS_CFG, PersonnelRole (+10 more)
...
Cohesion: 0.15
Nodes (11): recharts, CURRENT_YEAR, Filters, IncidentTypeSlice, inputStyle, MonthlyTrendPoint, Period, PERIOD_OPTIONS (+3 more)
...
### Community 35 - "react"
Cohesion: 0.12
Nodes (19): input-otp, react, ManageTwoFactor(), Props, Props, TwoFactorSetupModal(), TwoFactorSetupStep(), InputOTP (+11 more)

### Community 36 - "Illuminate\Http\RedirectResponse"
Cohesion: 0.35
Nodes (5): IncidentActionController, Illuminate\Http\RedirectResponse, Illuminate\Support\Facades\DB, Illuminate\Validation\Rule, Illuminate\Validation\ValidationException
...
### Community 38 - "portal-layout.tsx"
Cohesion: 0.19
Nodes (9): leaflet, AuroraBackground(), PortalLayout(), Incident, incidentIcon(), ResponseTracking(), RouteSummary, Station (+1 more)
...
Cohesion: 0.29
Nodes (9): NavUser(), Sidebar(), SidebarProvider(), SidebarRail(), useSidebar(), getServerSnapshot(), isSmallerThanBreakpoint(), mediaQueryListener() (+1 more)
...
### Community 62 - "UserFactory.php"
Cohesion: 0.22
Nodes (3): BfpAccountSeeder, Illuminate\Support\Facades\Hash, Inertia\Testing\AssertableInertia

### Community 63 - "show.tsx"
Cohesion: 0.22
Nodes (6): PortalCard(), SinglePointMap(), SeverityBadge(), Barangay, LinkedReport, ReportDetail

### Community 64 - "Inertia\Response"
Cohesion: 0.15
Nodes (10): AnalyticsController, DashboardController, FireMapController, RiskAnalyticsController, IncidentRecord, BarangayRiskSnapshot, Carbon\CarbonInterface, Illuminate\Support\Facades\Date (+2 more)
...
### Community 82 - "personnel-form-modal.tsx"
Cohesion: 0.24
Nodes (13): Props, PersonnelRow, ROLE_OPTIONS, STATUS_OPTIONS, Dialog(), DialogClose(), DialogContent(), DialogDescription() (+5 more)

### Community 83 - "User.php"
Cohesion: 0.14
Nodes (10): Attribute, Illuminate\Database\Eloquent\Attributes\Fillable, Illuminate\Database\Eloquent\Attributes\Hidden, Illuminate\Database\Eloquent\Casts\Attribute, Illuminate\Database\Eloquent\Relations\HasOne, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable, Laravel\Fortify\Contracts\PasskeyUser (+2 more)

### Community 103 - "app-header.tsx"
Cohesion: 0.14
Nodes (17): @radix-ui/react-navigation-menu, @radix-ui/react-tooltip, mainNavItems, Props, rightNavItems, NavigationMenu(), NavigationMenuContent(), NavigationMenuIndicator() (+9 more)

### Community 104 - "lucide-react"
Cohesion: 0.16
Nodes (8): lucide-react, AppearanceToggleTab(), Heading(), ManagePasskeys(), Props, PasskeyItem(), PasskeyRegistration(), IconProps
...
## Knowledge Gaps
- **504 isolated node(s):** `php`, `$schema`, `style`, `rsc`, `tsx` (+499 more)
...
- **Why does `react` connect `react` to `button.tsx`, `@inertiajs/react`, `index.ts`, `map/index.tsx`, `package.json`, `personnel/index.tsx`, `app-sidebar.tsx`, `utils.ts`, `cn`, `use-appearance.tsx`, `incidents/index.tsx`, `portal-layout.tsx`, `breadcrumbs.tsx`, `two-factor-recovery-codes.tsx`, `toggle-group.tsx`, `nav-user.tsx`, `show.tsx`, `personnel-form-modal.tsx`, `app-header.tsx`, `lucide-react`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `package.json`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `@inertiajs/react` connect `@inertiajs/react` to `button.tsx`, `index.ts`, `map/index.tsx`, `package.json`, `personnel/index.tsx`, `app-sidebar.tsx`, `utils.ts`, `use-appearance.tsx`, `incidents/index.tsx`, `status-badge.tsx`, `analytics/index.tsx`, `auth.ts`, `react`, `portal-layout.tsx`, `breadcrumbs.tsx`, `two-factor-recovery-codes.tsx`, `notifications/index.tsx`, `nav-user.tsx`, `show.tsx`, `personnel-form-modal.tsx`, `app-header.tsx`, `lucide-react`, `dashboard.tsx`?**
