...
### Community 0 - "react"
Cohesion: 0.05
Nodes (58): @inertiajs/react, input-otp, react, AlertError(), Heading(), InputError(), ManagePasskeys(), Props (+50 more)

### Community 1 - "personnel-form-modal.tsx"
Cohesion: 0.11
Nodes (34): sonner, AnnouncementRow, TYPE_OPTIONS, CompleteReportModal(), INCIDENT_TYPES, SEVERITY_LEVELS, Barangay, IncidentActions() (+26 more)
...
Cohesion: 0.10
Nodes (34): leaflet, react-leaflet, BarangayFeature, BarangayGeoProperties, BarangayRiskMap(), BARANGAY_GEOJSON_URL, GEOJSON_TO_DB_BARANGAY_NAME, resolveDbBarangayName() (+26 more)
...
### Community 6 - "User"
Cohesion: 0.10
Nodes (12): User, Attribute, Illuminate\Database\Eloquent\Attributes\Fillable, Illuminate\Database\Eloquent\Attributes\Hidden, Illuminate\Database\Eloquent\Casts\Attribute, Illuminate\Database\Eloquent\Factories\HasFactory, Illuminate\Database\Eloquent\Relations\HasMany, Illuminate\Foundation\Auth\User (+4 more)
...
Cohesion: 0.11
Nodes (25): lucide-react, DeletePersonnelDialog(), PersonnelFormModal(), DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuGroup(), DropdownMenuItem() (+17 more)
...
### Community 10 - "cn"
Cohesion: 0.09
Nodes (44): @radix-ui/react-navigation-menu, AppSidebar(), footerNavItems, mainNavItems, NavFooter(), NavMain(), NavUser(), NavigationMenu() (+36 more)

### Community 11 - "use-current-url.ts"
Cohesion: 0.31
...
Cohesion: 0.09
Nodes (21): @radix-ui/react-dialog, @radix-ui/react-tooltip, mainNavItems, Props, rightNavItems, AppLogo(), AppLogoIcon(), Sheet() (+13 more)
...
Cohesion: 0.21
Nodes (9): PaginationBar(), SeverityBadge(), BarangayOption, Filters, IncidentRow, inputStyle, STATUS_FILTERS, Paginated (+1 more)

### Community 20 - "status-badge.tsx"
Cohesion: 0.15
Nodes (18): PersonnelStatusBadge(), RoleBadge(), ANNOUNCEMENT_CFG, AnnouncementType, BadgeCfg, PERSONNEL_STATUS_CFG, PersonnelRole, PersonnelStatus (+10 more)
...
Cohesion: 0.10
Nodes (17): recharts, BarangayRiskPoint, KPICard(), PortalCard(), CURRENT_YEAR, Filters, IncidentTypeSlice, inputStyle (+9 more)
...
Cohesion: 0.21
Nodes (6): AnnouncementFormModal(), DeleteAnnouncementDialog(), AuroraBackground(), AnnouncementBadge(), PortalLayout(), PortalTopbar()

### Community 39 - "breadcrumbs.tsx"
Cohesion: 0.24
Nodes (10): @radix-ui/react-slot, Badge(), badgeVariants, Breadcrumb(), BreadcrumbEllipsis(), BreadcrumbItem(), BreadcrumbLink(), BreadcrumbList() (+2 more)
...
### Community 44 - "user-info.tsx"
Cohesion: 0.24
Nodes (9): @radix-ui/react-avatar, Avatar(), AvatarFallback(), AvatarImage(), getInitial(), GetInitialsFn, useInitials(), PersonnelIndex() (+1 more)
...
### Community 62 - "BfpAccountSeeder.php"
Cohesion: 0.25
Nodes (3): BfpAccountSeeder, Illuminate\Support\Facades\Hash, Inertia\Testing\AssertableInertia

### Community 63 - "show.tsx"
Cohesion: 0.25
Nodes (5): SinglePointMap(), StatusBadge(), Barangay, LinkedReport, ReportDetail

### Community 64 - "IncidentRecord"
Cohesion: 0.28
Nodes (4): AnalyticsController, DashboardController, IncidentRecord, Carbon\CarbonInterface
...
### Community 82 - "Configuration Best Practices"
Cohesion: 0.33
...
## Knowledge Gaps
- **503 isolated node(s):** `php`, `$schema`, `style`, `rsc`, `tsx` (+498 more)
...
- **Why does `react` connect `react` to `personnel-form-modal.tsx`, `index.ts`, `map/index.tsx`, `portal-layout.tsx`, `package.json`, `breadcrumbs.tsx`, `lucide-react`, `cn`, `user-info.tsx`, `app-header.tsx`, `use-appearance.tsx`, `incidents/index.tsx`, `toggle-group.tsx`, `useIsMobile`, `dashboard.tsx`, `show.tsx`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `@inertiajs/react` connect `react` to `auth.ts`, `personnel-form-modal.tsx`, `index.ts`, `map/index.tsx`, `portal-layout.tsx`, `package.json`, `breadcrumbs.tsx`, `lucide-react`, `cn`, `use-current-url.ts`, `app-header.tsx`, `notifications/index.tsx`, `use-appearance.tsx`, `incidents/index.tsx`, `status-badge.tsx`, `dashboard.tsx`, `show.tsx`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `lucide-react` connect `lucide-react` to `react`, `personnel-form-modal.tsx`, `auth.ts`, `map/index.tsx`, `portal-layout.tsx`, `package.json`, `breadcrumbs.tsx`, `cn`, `app-header.tsx`, `notifications/index.tsx`, `use-appearance.tsx`, `incidents/index.tsx`, `status-badge.tsx`, `dashboard.tsx`, `show.tsx`?**
...
- **Should `personnel-form-modal.tsx` be split into smaller, more focused modules?**
